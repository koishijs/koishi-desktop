...
import { versionAppimagetool } from '../../utils/config'
import { exists } from '../../utils/fs'
import { download } from '../../utils/net'
import { dir } from '../../utils/path'

const src = `https://github.com/AppImage/AppImageKit/releases/download/${versionAppimagetool}/appimagetool-x86_64.AppImage`
